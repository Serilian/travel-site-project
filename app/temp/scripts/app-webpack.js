...
exports.RevealOnScroll = undefined;
...
var RevealOnScroll = exports.RevealOnScroll = function () {
    function RevealOnScroll(elementSelector, offset) {
...
var StickyHeader = exports.StickyHeader = function () {
    ...
    _createClass(StickyHeader, [{
        ...
        key: 'createWaypoint',
        value: function createWaypoint(element) {
            var trigger = document.querySelector(".large-hero__title");
            new Waypoint({
                element: trigger,
        ...
        value: function createPageSectionWaypoints(collection, headerLinks) {
            ...
            collection.forEach(function (item) {
                new Waypoint({
                    ...
                    handler: function handler(direction) {
                        if (direction === 'down') {
                            var matchingHeaderId = item.getAttribute("data-matching-link");
